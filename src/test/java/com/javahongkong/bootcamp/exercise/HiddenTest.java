...
public class HiddenTest {
  ...
  public void debitTest() {
    ...
    assertFalse("Account " + bob + " should have insufficient funds.",
        bank.debit(bob, amount));
  ...
  public void bankCreditTest() {
    ...
    assertEquals(23.45, bank.getBalance(john), 0);
    assertEquals(480.23, bank.getBalance(julia), 0);
    assertEquals(523.45, bank.getBalance(daniel), 0);
    assertEquals(23.45, bank.getBalance(bob), 0);
    assertEquals(123456812.45, bank.getBalance(smith), 0);
  }
  ...
  public void bankDeditTest() {
    double amount = 23.43;
    bank.debit(julia, amount);
    assertEquals(433.35, bank.getBalance(julia), 0);
  }
