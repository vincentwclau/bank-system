...
public class SampleTest {
  ...
  public void setUp() throws Exception {
    ...
    hackerRank =
        bank.openCommercialAccount(company2hackerRank, 2222, 9876543.21);
  }
  ...
  public void invalidAccountNumberTest() {
    ...
    Assert.assertNotEquals(bank.getBalance(ameliaPond),
        bank.getBalance(roseTyler));
    Assert.assertNotEquals(bank.getBalance(acmeCorp),
        bank.getBalance(hackerRank));
  }
  ...
  public void bankCreditTest() {
    ...
    assertEquals(23.45, bank.getBalance(ameliaPond), 0);
    assertEquals(480.23, bank.getBalance(roseTyler), 0);
    assertEquals(23.45, bank.getBalance(acmeCorp), 0);
    assertEquals(9876566.66, bank.getBalance(hackerRank), 0);
  }

 @Test
  public void bankDeditTest() {
    double amount = 23.43;
    bank.debit(roseTyler, amount);
    assertEquals(433.35, bank.getBalance(roseTyler), 0);
  }

  @Test
  public void additionalTest() {
    assertThat(Person.class, Matchers.typeCompatibleWith(AccountHolder.class));
    assertThat(Company.class, Matchers.typeCompatibleWith(AccountHolder.class));
    assertThat(ConsumerAccount.class, Matchers.typeCompatibleWith(Account.class));
    assertThat(CommercialAccount.class, Matchers.typeCompatibleWith(Account.class));
    assertThat(Account.class, Matchers.typeCompatibleWith(AccountInterface.class));
    assertThat(Bank.class, Matchers.typeCompatibleWith(BankInterface.class));
    assertThat(Transaction.class, Matchers.typeCompatibleWith(TransactionInterface.class));
  }
